...
2. once the service is running locally, you can view the specs [here](http://api.cwb03.test/um/swagger-ui/index.html) `http://api.cwb03.test/um/swagger-ui/index.html`
...
3. Add host as `db.cwb03.test` and the port as `30202`
